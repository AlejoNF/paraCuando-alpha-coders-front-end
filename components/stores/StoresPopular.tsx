...
const StoresPopular = () => {
  return (
    <div>
      <div className="container  w-[1070px] h-[600px] mt-[10px] justify-center ml-[80px] mr[80px]">
      ...
      <div className="ml-[89.5%] absolute top-[123%] cursor-pointer hover:brightness-125">
